...
Por otra parte, en lo que respecta a los clientes es habitual que tengan dudas con respecto a que inmueble alquilar o el momento óptimo para realizarlo. Tienen que tener en cuenta aspectos como el precio de los inmuebles, fechas, disponibilidad, actividades que quieren desarrollar, como los monumentos o sitios que visitar y la cercanía a una plaza de aparcamiento que le resulte lo más asequible posible.
...
* Arrendadores:
    ...
    * Obtener información sobre el potencial interés de los clientes en base a las búsquedas o alquileres de inmuebles cercanos, así como el análisis del histórico anual para predecir los periodos de mayor actividad.
...
* Arrendatarios:
    * Realizar una búsqueda que filtre inmuebles en base a intereses personales, como el lugar, fechas en la que realizar el viaje, periodo de menor actividad turística, actividades que realizar, plazas de aparcamiento cercanas al inmueble o las valoraciones del inmueble y el arrendador.
    * Realizar una oferta por la reserva del inmueble. El arrendador establece un precio/día y periodo máximo de estancia en el propio anuncio del inmueble, pero se le permite al cliente que realice una oferta alternativa que será valorada por el arrendador.
